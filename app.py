...
# Default page is to load basic html file for the user to upload the switch configuration file
@app.route('/')
def read():
...
def result():
    ...
    the_list,unsupported_features,More_info = read_conf.read.Checking_features(sw_file)
